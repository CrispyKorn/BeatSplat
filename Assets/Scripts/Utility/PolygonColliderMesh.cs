...
public class PolygonColliderMesh : MonoBehaviour
{
    ...
    public void UpdateMesh()
    {
        ...
        // Reverse points to order polygon counter clockwise
...
#if UNITY_EDITOR
[CustomEditor(typeof(PolygonColliderMesh)), CanEditMultipleObjects]
public class PolygonColliderMeshEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        if (GUILayout.Button("Update Mesh"))
        {
            ...
            {
                PolygonColliderMesh meshScript = obj as PolygonColliderMesh;
